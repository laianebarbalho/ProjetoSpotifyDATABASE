...
DROP DATABASE IF EXISTS Projeto_Spotify;
CREATE SCHEMA Projeto_Spotify;
USE `Projeto_Spotify` ;
...
INSERT INTO `artista` VALUES (1,'Pink Floyd','Pink Floyd.jpg'),(2,'AC/DC',NULL),(3,'The Rolling Stones','The Rolling Stones.jpg'),
(4,'The Beatles',NULL),(5,'Guns\'n Roses','Guns\'n Roses.jpg'),(6,'Linkin Park',NULL),(7,'Madonna','Madonna.jpg'),(8,'Fito Paez',NULL),(9,'Diego Torres','Diego Torres.jpg'),
(10,'Shakira',NULL),(11,'Maluma','Maluma.jpg'),(12,'Carlos Vives',NULL),(13,'Karol G','Karol G.jpg'),(14,'Yo-Yo Ma',NULL),(15,'Michael Finnissy','Michael Finnissy.jpg'),
(16,'John Adams',NULL),(17,'John Corigliano','John Corigliano.jpg'),(18,'Terry Riley',NULL),(19,'Brian John Peter Ferneyhough','Brian John Peter Ferneyhough.jpg'),
(20,'Charlie Parker',NULL),(21,'MIles Davis','MIles Davis.jpg'),(22,'Dizzy Gillespie',NULL),(23,'Coleman Hawkins','Coleman Hawkins.jpg'),(24,'Billie Holiday',NULL),
(25,'Ray Charles','Ray Charles.jpg'),(26,'Chet Baker',NULL),(27,'Celia Cruz','Celia Cruz.jpg'),(28,'Ruben Blades',NULL),(29,'Willie Colon','Willie Colon.jpg'),
(30,'Hector Lavoe',NULL),(31,'Tito Rodriguez','Tito Rodriguez.jpg'),(32,'Luis Enrique',NULL),(33,'Astor Piazzolla','Astor Piazzolla.jpg'),(34,'Carlos Gardel',NULL),
(35,'Adriana Varela','Adriana Varela.jpg'),(36,'Alberto Podestá',NULL),(37,'Bajofondo Tango Club','Bajofondo Tango Club.jpg'),(38,'Susana Rinaldi',NULL),(39,'Dr. Dre','Dr. Dre.jpg'),
(40,'Eminem',NULL),(41,'Snoop Dogg','Snoop Dogg.jpg'),(42,'Jay-Z',NULL),(43,'Beastie Boys','Beastie Boys.jpg'),(44,'Kanye West',NULL),(45,'Carl Cox','Carl Cox.jpg'),(46,'Marco Carola',NULL),
(47,'Oscar Mulero','Oscar Mulero.jpg'),(48,'Nina Kraviz',NULL),(49,'Adam Beyer','Adam Beyer.jpg'),(50,'Solomun',NULL);
...
CREATE TABLE `cancao` (
  ...
  `qtdreproducao` int DEFAULT NULL,
  `qtdlikes` int DEFAULT NULL,
...
CREATE TABLE `dadospagoxusuario` (
  `iddadospagoxusuario` int NOT NULL,
...
CREATE TABLE `generoxcancao` (
  `idGeneroxcancao` int NOT NULL,
  `Idcancao` int DEFAULT NULL,
...
CREATE TABLE `playlistxcancao` (
  `idPlaylistxcancao` int NOT NULL,
  `Idcancao` int DEFAULT NULL,
